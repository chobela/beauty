...
<?php
$ret=mysqli_query($con,"select distinct tblinvoice.ID, tbluser.FirstName,tbluser.LastName,tblinvoice.BillingId,date(tblinvoice.PostingDate) as invoicedate from  tbluser join tblinvoice on tbluser.ID=tblinvoice.Userid  order by tblinvoice.ID desc");
$cnt=1;
